              ...
              },
              {
                ...
                label: (
                  ...
                  },
                  {
                    ...
                    icon: <i className="fa-solid fa-table-cells-large"></i>,
                    label: (
                      <Link to="/Coursess/AddCourses" className="text-decoration-none">
                        Add Courses
                      </Link>
                    ),
                  },
        ...
        <Layout>
          ...
          <Content className="content-home">
            <Routes>
              ...
              <Route path='/Courses' element={<Courses />} />
              <Route path='/Coursess/EditCoursess' element={<EditCourses />} />
              <Route path='/Coursess/AddCourses' element={<AddCourses />} />
